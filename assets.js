...
function all_assets(req, res) {
    ...
    var sql1 = `SELECT distinct assets.*,hos.Name as hostel_Name,hosfloor.floor_name,aa.room_id,aname.asset_name,ven.Vendor_Name,aa.asset_id AS Asset_id,aa.hostel_id,
aa.room_id,aa.assigned_date FROM assets JOIN Vendor AS ven ON ven.id=assets.vendor_id LEFT JOIN assigned_assets AS aa ON assets.id=aa.asset_id 
