...
function check_bed_details(bed_details_obj) {
    ...
    return new Promise((resolve, reject) => {
        ...
        if (bed_details_obj.old_hostel == bed_details_obj.hostel_Id && bed_details_obj.old_floor == bed_details_obj.Floor && bed_details_obj.old_room == bed_details_obj.Rooms && bed_details_obj.old_bed == bed_details_obj.Bed) {
            resolve("Success")
        } else {
