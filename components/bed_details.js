...
function check_bed_details(bed_details_obj) {
    ...
    return new Promise((resolve, reject) => {
        ...
        if (bed_details_obj.floor_id == 0 || bed_details_obj.floor_id == undefined && bed_details_obj.room == 0 || bed_details_obj.room == undefined) {
            ...
            if (bed_details_obj.old_hostel == bed_details_obj.hostel_id && bed_details_obj.old_floor == bed_details_obj.floor_id && bed_details_obj.old_room == bed_details_obj.room && bed_details_obj.old_bed == bed_details_obj.bed) {
                resolve("Success")
            } else {
