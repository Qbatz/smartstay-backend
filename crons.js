...
//                 var join_date = user_data.join_date;
//                 var user_id = user_data.ID;
//                 var room_rent = user_data.RoomRent;
//                 var unique_user = user_data.User_Id;

//                 var sql2 = "SELECT *,DATE_FORMAT(Date, '%Y-%m-%d') AS date FROM invoicedetails WHERE hos_user_id=? AND invoice_status=1 ORDER BY id DESC";
...
//                         // Check Last Invoice to Current Date

//                         var last_inv_date = inv_data[0].date;
//                         console.log(join_date, "Joining Date");
//                         // Check Eb Amounts
//                         var sql2 = "SELECT SUM(amount) AS eb_amount FROM customer_eb_amount WHERE user_id = " + user_id + " AND status = 1 AND date BETWEEN '" + last_inv_date + "' AND CURDATE()";
//                         connection.query(sql2, function (err, eb_data) {
//                             if (err) {
//                                 console.log("Error Fetching Eb Details", err.message);
//                             } else {
//                                 var total_ebamount = eb_data[0].eb_amount || 0;

//                                 var sql3 = "SELECT DATEDIFF(CURDATE(), '" + last_inv_date + "') AS days_difference;";
//                                 connection.query(sql3, function (err, ch_date) {
//                                     if (err) {
//                                         console.log("Error Fetching Dates Count", err.message);
//                                     } else {
//                                         var stay_days = ch_date[0].days_difference;
//                                         const currentDate = new Date();
//                                         const currentYear = currentDate.getFullYear();
...
//                         })
//                     } else {
//                         // Check Joining Date to Current Date
//                     }
//                 })
