...
const queries = [
    ...
    "ALTER TABLE `hostel`ADD COLUMN `area` VARCHAR(255) NULL AFTER `doc2`,ADD COLUMN `landmark` VARCHAR(255) NULL AFTER `area`,ADD COLUMN `pincode` INT NULL AFTER `landmark`,ADD COLUMN `city`VARCHAR(255) NULL AFTER `pincode`,ADD COLUMN `state` VARCHAR(45) NULL AFTER `city`;",
    "ALTER TABLE `bookings` ADD COLUMN `area` VARCHAR(255) NULL AFTER `address`,ADD COLUMN `landmark` VARCHAR(255) NULL AFTER `area`,ADD COLUMN `pin_code` INT NULL AFTER `landmark`,ADD COLUMN `city` VARCHAR(255) NULL AFTER `pin_code`,ADD COLUMN `state` VARCHAR(45) NULL AFTER `city`;",
