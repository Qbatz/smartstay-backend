...
const queries = [
  ...
  "ALTER TABLE bookings ADD COLUMN customer_Id BIGINT(20),ADD COLUMN customer_inactive BOOLEAN DEFAULT FALSE, ADD COLUMN booking_date DATE, ADD COLUMN inactive_reason VARCHAR(255),ADD COLUMN inactive_date DATE;",
