                        ...
                        .then((okda) => {
                          connection.query(
                            `UPDATE hostel SET Circle='${Circle}', Name='${Name}',Phone='${atten.Phone
                              ...
                              Address='${escape(atten.Address || "")}', AadharNo='${atten.AadharNo}', PancardNo='${atten.PancardNo
                            ...
                            landmark='${escape(atten.landmark || "")}',pincode='${atten.pincode}',city='${atten.city
  ...
  return String(value)
    ...
    .replace(/'/g, "''");    
                        ...
                        connection.query(
                          ...
                          '${escape(area || "")}',
                         '${escape(landmark || "")}','${pincode}','${city}','${state}','${atten.stay_type
                          }')`,
